  ...
  <div class="registrationPage">
    <div class="registrationPage__column">
      <div class="registrationPage__registrationWrapper">
        ...
        <span
          class="registrationPage__entrance"
          @click="switchIsLogin">
        ...
        <form @submit.prevent="auth">
          ...
          <div
            class="registrationPage__inputWrapper"
            v-if="!isLogin">
          ...
          <div class="registrationPage__inputWrapper">
            <div class="registrationPage__descriptionContainer">
              ...
              <p
                class="registrationPage__forgotPassword"
                v-if="!isLogin">
                Забыли пароль?
              </p>
            </div>
          ...
          <div class="registrationPage__buttonWrapper">
            <button
              type="submit"
              class="registrationPage__button">
              <div class="registrationPage__buttonText">
                {{ isLogin ? 'Войти' : 'Зарегистрироваться' }}
              </div>
              <img
                :src="imgArrow"
                class="registrationPage__buttonImage"
                type="submit" />
            </button>
          </div>
        </form>
